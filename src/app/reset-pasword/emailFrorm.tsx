...
import { sendToken } from "@/lib/action";
...
const InputEmailForm = () => {
  ...
  useEffect(() => {
   ...
   const handleSubmit = async (e: any) => {
    ...
    try {
      const result = await sendToken(email)
  ...
  return (
    <div>
      ...
      <div className="relative min-h-screen flex items-center justify-center">
        <div className="border-2 border-zinc-500 bg-black bg-opacity-40 backdrop-blur-lg  relative w-full h-full max-w-md p-8 m-4 shadow-lg rounded-lg z-10">
